...
public class JvmOutlineTests extends AbstractOutlineTests {
  ...
  protected StructureViewComponent getStructureViewComponent(final StructureView structureView) {
    ...
    return ObjectExtensions.<StructureViewComponent>operator_doubleArrow(
      ((StructureViewComponent) IterableExtensions.<StructureViewComposite.StructureViewDescriptor>last(((Iterable<StructureViewComposite.StructureViewDescriptor>)Conversions.doWrapArray(((StructureViewComposite) structureView).getStructureViews()))).structureView), _function);
  }
