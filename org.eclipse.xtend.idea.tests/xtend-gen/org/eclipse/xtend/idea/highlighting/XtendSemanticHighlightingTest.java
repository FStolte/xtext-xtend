...
public class XtendSemanticHighlightingTest extends LightXtendTest {
  ...
  protected void checkHighlight(final CharSequence text) {
    this.myFixture.addFileToProject("Foo.xtend", text.toString().replace(XtendSemanticHighlightingTest.NL, "\n"));
  ...
  public void testStaticField() {
    ...
    CharSequence _$_1 = this.$(XbaseHighlightingStyles.FIELD, this.$(XbaseHighlightingStyles.STATIC_FIELD, this.$(XbaseHighlightingStyles.STATIC_FINAL_FIELD, "foo")));
    _builder.append(_$_1, "\t");
    ...
    _builder.append(_$_2, "\t");
    _builder.append("() { ");
    CharSequence _$_3 = this.$(XbaseHighlightingStyles.FIELD, this.$(XbaseHighlightingStyles.STATIC_FIELD, this.$(XbaseHighlightingStyles.STATIC_FINAL_FIELD, "foo")));
    _builder.append(_$_3, "\t");
    _builder.append(" }");
    _builder.newLineIfNotEmpty();
    _builder.append("}");
  ...
  public void testStaticMethod() {
    ...
    _builder.append(_$_2, "\t");
    _builder.append("() { ");
    CharSequence _$_3 = this.$(XbaseHighlightingStyles.METHOD, this.$(XbaseHighlightingStyles.STATIC_METHOD_INVOCATION, "foo"));
    _builder.append(_$_3, "\t");
    _builder.append(" }");
    _builder.newLineIfNotEmpty();
    _builder.append("}");
  ...
  public void testExtensionMethod() {
    ...
    _builder.append("\t\t");
    _builder.append("\'\'.");
    CharSequence _$_5 = this.$(XbaseHighlightingStyles.EXTENSION_METHOD_INVOCATION, this.$(XbaseHighlightingStyles.METHOD, "foo"));
  ...
  public void ignoreRichText_2() {
    ...
    _builder.append("FOR ");
    CharSequence _$_6 = this.$(XbaseHighlightingStyles.LOCAL_FINAL_VARIABLE_DECLARATION, this.$(XbaseHighlightingStyles.LOCAL_VARIABLE_DECLARATION, "i"));
    _builder.append(_$_6, "\t");
    _builder.append(":");
    CharSequence _$_7 = this.$(XbaseHighlightingStyles.PARAMETER_VARIABLE, "nums");
    _builder.append(_$_7, "\t");
    _builder.append(XtendSemanticHighlightingTest.GR, "\t");
    CharSequence _$_8 = this.$(XtendHighlightingStyles.INSIGNIFICANT_TEMPLATE_TEXT, XtendSemanticHighlightingTest.NL);
    ...
    CharSequence _$_9 = this.$(XtendHighlightingStyles.SEMANTIC_LINE_BREAK, XtendSemanticHighlightingTest.NL);
    ...
    _builder.append(XtendSemanticHighlightingTest.GR, "\t");
    CharSequence _$_10 = this.$(XtendHighlightingStyles.INSIGNIFICANT_TEMPLATE_TEXT, XtendSemanticHighlightingTest.NL);
    _builder.append(_$_10, "\t");
    CharSequence _white_6 = this.white("\t\t");
    _builder.append(_white_6, "\t");
    _builder.append("this is not indented");
    CharSequence _$_11 = this.$(XtendHighlightingStyles.SEMANTIC_LINE_BREAK, XtendSemanticHighlightingTest.NL);
