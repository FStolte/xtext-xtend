...
public class IdeaFileSystemTest extends PsiTestCase {
  ...
  private static class Delegate extends JavaIoFileSystemTest {
    ...
    public void assertToURI(final Path file, final String expectedContent) {
      IdeaResourceSetProvider.VirtualFileBasedUriHandler.find(this._ideaFileSystemTest.resourceSet).flushToDisk();
  ...
  protected void setUp() throws Exception {
    ...
    this.resourceSet = this.ideaResourceSetProvider.get(this.getModule());
  ...
  protected Module createModule(final String moduleName) {
    Module _xblockexpression = null;
    {
      ...
      final VirtualFile moduleDir = PlatformTestCase.createChildDirectory(this.getProject().getBaseDir(), moduleName);
