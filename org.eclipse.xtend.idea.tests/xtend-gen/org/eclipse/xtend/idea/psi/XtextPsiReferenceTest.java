...
public class XtextPsiReferenceTest extends LightXtendTest {
  ...
  public void testGetTextOffset() {
    ...
    TestCase.assertTrue(_plus_1, textRange.contains(textOffset));
  }
  ...
  public void testDeclaredType() {
    ...
    if ((referencedElement instanceof PsiClass)) {
      TestCase.assertEquals("java.lang.String", ((PsiClass)referencedElement).getQualifiedName());
    } else {
  ...
  public void testConstructor() {
    ...
    if ((referencedElement instanceof PsiMethod)) {
      TestCase.assertTrue(((PsiMethod)referencedElement).isConstructor());
      TestCase.assertEquals("String", ((PsiMethod)referencedElement).getName());
    } else {
      TestCase.fail(("" + referencedElement));
    }
  }
  ...
  public void testField() {
    ...
    if ((referencedElement instanceof PsiField)) {
      TestCase.assertEquals("myField", ((PsiField)referencedElement).getName());
    } else {
      TestCase.fail(("" + referencedElement));
    }
  }
  ...
  public void testEnumLiteral() {
    ...
    if ((referencedElement instanceof PsiEnumConstant)) {
      TestCase.assertEquals("MY_ENUM_LITERAL", ((PsiEnumConstant)referencedElement).getName());
    } else {
      TestCase.fail(("" + referencedElement));
    }
  }
  ...
  public void testMethod() {
    ...
    final PsiElement referencedElement = reference.resolve();
    if ((referencedElement instanceof PsiMethod)) {
      TestCase.assertFalse(((PsiMethod)referencedElement).isConstructor());
      TestCase.assertEquals("myMethod", ((PsiMethod)referencedElement).getName());
    } else {
      TestCase.fail(("" + referencedElement));
    }
  }
